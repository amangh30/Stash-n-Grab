        ...
        <div className="flex flex-wrap gap-4 py-8 justify-center md:justify-start items-center">
          ...
          {user && (
            <button 
              ...
              disabled={isCreating}
              className={`px-8 py-3.5 rounded-2xl font-black text-sm uppercase tracking-widest shadow-[0_10px_20px_rgba(147,51,234,0.3)] transition-all flex items-center justify-center gap-2 ${
                isCreating 
                  ? "bg-purple-500 text-white opacity-90 cursor-not-allowed pointer-events-none" 
                  : "bg-purple-600 text-white hover:bg-purple-500 hover:-translate-y-0.5 active:scale-95"
              }`}
            >
              {isCreating ? (
                <>
