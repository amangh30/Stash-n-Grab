                  ...
                  >
                    ...
                    <div className="mt-8 pt-6 border-t border-slate-100 dark:border-white/5 relative z-10">
                      <button
                        ...
                        className="w-full py-3 text-xs font-black uppercase tracking-widest bg-slate-100 dark:bg-white/10 text-slate-900 dark:text-white rounded-xl hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-black transition-all active:scale-95"
                      >
                        Inspect Path ↗
                      </button>
                    </div>
